...
class MainWindow(Gtk.ApplicationWindow):
    ...
    def on_start_stop_spinner_button_toggled(self,start_stop_spinner_button,spinner):
        if start_stop_spinner_button.get_active():
            spinner.start()
        else:
            spinner.stop()
...
[Gtk.CheckButton](https://lazka.github.io/pgi-docs/#Gtk-4.0/classes/CheckButton.html)
